...
public class EthernetInterfaceConfigImplTest {
    ...
    public void testToString1() {
        ...
        String expected = "name=ethInterface :: hardwareAddress= :: loopback=false" +
    ...
    public void testToString2() {
        ...
        String expected = "name=ethInterface :: hardwareAddress=12:34:56:78:90:AB" +
    ...
    public void testState() {
        ...
        config.setState(NetInterfaceState.UNKNOWN);
        assertEquals(NetInterfaceState.UNKNOWN, config.getState());
        
        config.setState(NetInterfaceState.UNMANAGED);
        assertEquals(NetInterfaceState.UNMANAGED, config.getState());
        
        config.setState(NetInterfaceState.UNAVAILABLE);
        assertEquals(NetInterfaceState.UNAVAILABLE, config.getState());
        ...
        config.setState(NetInterfaceState.CONFIG);
        assertEquals(NetInterfaceState.CONFIG, config.getState());
        
        config.setState(NetInterfaceState.NEED_AUTH);
        assertEquals(NetInterfaceState.NEED_AUTH, config.getState());
        
        config.setState(NetInterfaceState.IP_CONFIG);
        assertEquals(NetInterfaceState.IP_CONFIG, config.getState());
        
        config.setState(NetInterfaceState.IP_CHECK);
        assertEquals(NetInterfaceState.IP_CHECK, config.getState());
        
        config.setState(NetInterfaceState.SECONDARIES);
        assertEquals(NetInterfaceState.SECONDARIES, config.getState());
        
        config.setState(NetInterfaceState.ACTIVATED);
        assertEquals(NetInterfaceState.ACTIVATED, config.getState());
        
        config.setState(NetInterfaceState.DEACTIVATING);
        assertEquals(NetInterfaceState.DEACTIVATING, config.getState());
        
        config.setState(NetInterfaceState.FAILED);
        assertEquals(NetInterfaceState.FAILED, config.getState());
    }
    ...
    @Test
    public void testNetInterfaceAddresses() {
        try {
            EthernetInterfaceConfigImpl config = createConfig(2);
