...
public class ModemInterfaceConfigImplTest {
	...
	public void testToString1() throws UnknownHostException {
		...
		String expected = "name=ModemInterface :: hardwareAddress= :: loopback=false :: pointToPoint=false :: virtual=false"
	...
	@Test
	public void testToString2() throws UnknownHostException, KuraException {
		...
		String expected = "name=ModemInterface :: hardwareAddress=12:34:56:78:90:AB"
	...
	public void testTechnologyTypes() {
		...
		List<ModemTechnologyType> technologyTypes1 = new ArrayList<ModemTechnologyType>();
		...
		List<ModemTechnologyType> technologyTypes2 = new ArrayList<ModemTechnologyType>();
	...
	ModemInterfaceConfigImpl createConfig(int noOfAddresses) throws UnknownHostException {
		ModemInterfaceImpl<ModemInterfaceAddressConfigImpl> interfaceImpl = new ModemInterfaceImpl<ModemInterfaceAddressConfigImpl>(
				"ModemInterface");

		if (noOfAddresses > 0) {
			List<ModemInterfaceAddressConfigImpl> interfaceAddresses = new ArrayList<ModemInterfaceAddressConfigImpl>();
		...
		ModemInterfaceConfigImpl config = new ModemInterfaceConfigImpl(interfaceImpl);
		return config;
	}
